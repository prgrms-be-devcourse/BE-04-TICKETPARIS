...
import com.programmers.ticketparis.member.repository.mybatis.MybatisCustomerRepository;
...
class MybatisCustomerRepositoryTest {
    ...
    void createAccountTest() {
        ...
        Customer actualCustomer = myBatisCustomerRepository.findById(3L)
    ...
    void canNotCreateAccountWithDuplicateValueInUniqueColumn() {
        ...
        //when, then
        assertThatThrownBy(() -> myBatisCustomerRepository.save(customer)).isInstanceOf(DuplicateKeyException.class);
    }
    ...
    void findByIdTest() {
        //when
        Customer actualCustomer = myBatisCustomerRepository.findById(1L)
            .orElseThrow(NoSuchElementException::new);
