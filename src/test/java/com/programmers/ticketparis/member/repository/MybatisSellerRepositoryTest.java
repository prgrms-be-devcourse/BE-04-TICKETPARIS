...
import com.programmers.ticketparis.member.repository.mybatis.MybatisSellerRepository;
...
class MybatisSellerRepositoryTest {
    ...
    void createAccountTest() {
        ...
        Seller actualSeller = myBatisSellerRepository.findById(2L)
    ...
    void canNotCreateAccountWithDuplicateValueInUniqueColumn() {
        ...
        //when, then
        assertThatThrownBy(() -> myBatisSellerRepository.save(seller)).isInstanceOf(DuplicateKeyException.class);
    }
    ...
    void findByIdTest() {
        //when
        Seller actualSeller = myBatisSellerRepository.findById(1L)
            .orElseThrow(NoSuchElementException::new);
